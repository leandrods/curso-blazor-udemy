    ...
    public class Repositorio : IRepositorio
    {
        public List<Pelicula> ObtenerPeliculas()
        {
            return new List<Pelicula>{
                ...
                new Pelicula { Titulo = "Superman", Lanzamiento = new DateOnly(1978,1,1), Poster="https://m.media-amazon.com/images/M/MV5BZWRjNWNmMDgtYjZiNC00NThiLWI3MzQtODkxZGRhNjJkMzNmXkEyXkFqcGdeQXVyMTYzMDM0NTU@._V1_QL75_UY562_CR18,0,380,562_.jpg" }
            };
        }
    }
}